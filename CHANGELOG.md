...
- **Maintenance-Gems:** Bump omniauth-google-oauth2, omniauth-rails_csrf_protection and omniauth [\#4419](https://github.com/consuldemocracy/consuldemocracy/pull/4419) and [\#4649](https://github.com/consuldemocracy/consuldemocracy/pull/4649)
...
- **Maintenance-Gems:** Bump ahoy_matey from 1.6.0 to 3.2.0 [\#4635](https://github.com/consuldemocracy/consuldemocracy/pull/4635)
- **Maintenance-Gems:** Bump acts_as_votable from 0.12.1 to 0.13.1 [\#4634](https://github.com/consuldemocracy/consuldemocracy/pull/4634)
...
- **Maintenance-Gems:** Bump foundation_rails_helper from 3.0.0 to 4.0.0 [\#4617](https://github.com/consuldemocracy/consuldemocracy/pull/4617)
...
- **Maintenance-Gems:** Bump factory_bot_rails from 4.8.2 to 6.2.0 [\#4607](https://github.com/consuldemocracy/consuldemocracy/pull/4607)
...
- **Maintenance-Gems:** Bump erb_lint from 0.0.35 to 0.0.37 [\#4423](https://github.com/consuldemocracy/consuldemocracy/pull/4423)
...
- **Maintenance-Gems:** Bump delayed_job_active_record from 4.1.4 to 4.1.5 [\#4416](https://github.com/consuldemocracy/consuldemocracy/pull/4416)
...
- **Maintenance-Gems:** Bump invisible_captcha from 1.1.0 to 2.0.0 [\#4410](https://github.com/consuldemocracy/consuldemocracy/pull/4410)
- **Maintenance-Gems:** Bump database_cleaner from 1.8.5 to 2.0.1 [\#4409](https://github.com/consuldemocracy/consuldemocracy/pull/4409)
- **Maintenance-Gems:** Bump paranoia from 2.4.2 to 2.4.3 [\#4408](https://github.com/consuldemocracy/consuldemocracy/pull/4408)
- **Maintenance-Gems:** Bump recipient_interceptor from 0.2.0 to 0.3.0 [\#4407](https://github.com/consuldemocracy/consuldemocracy/pull/4407)
- **Maintenance-Gems:** Bump view_component from 2.19.1 to 2.37.0 [\#4400](https://github.com/consuldemocracy/consuldemocracy/pull/4400) and [\#4619](https://github.com/consuldemocracy/consuldemocracy/pull/4619)
...
- **Maintenance-Gems:**Bump knapsack_pro from 2.6.0 to 3.0.0 [\#4307](https://github.com/consuldemocracy/consuldemocracy/pull/4307) and [\#4639](https://github.com/consuldemocracy/consuldemocracy/pull/4639)
...
- **Security:** Apply escape_javascript security patch [\#3963](https://github.com/consuldemocracy/consuldemocracy/pull/3963)
...
- **Translations:** Get search dictionary based on I18n.default_locale [\#3856](https://github.com/consuldemocracy/consuldemocracy/pull/3856) and [\#4050](https://github.com/consuldemocracy/consuldemocracy/pull/4050)
...
- **Maintenance-Gems:** Bump sitemap_generator from 6.0.1 to 6.0.2 [\#3848](https://github.com/consuldemocracy/consuldemocracy/pull/3848)
...
- **Budgets:** Add task to regenerate ballot_lines_count cache [\#3563](https://github.com/consuldemocracy/consuldemocracy/pull/3563)
...
- **Proposals:** Add rake to move external_url to description [\#3396](https://github.com/consuldemocracy/consuldemocracy/pull/3396)
...
- **Maintenance-Refactorings:** Use find instead of find_by_id [\#3234](https://github.com/consuldemocracy/consuldemocracy/pull/3234)
...
- **Maintenance-Rubocop:** Apply Rubocop not_to rule [\#3118](https://github.com/consuldemocracy/consuldemocracy/pull/3118)
- **Maintenance-Rubocop:** Add not_to Rubocop rule [\#3112](https://github.com/consuldemocracy/consuldemocracy/pull/3112)
...
- **Maintenance:** Removed icon_home and fixed corresponding test [\##2970](https://github.com/consuldemocracy/consuldemocracy/pull/2970)
...
- **Maintenance-Gems:** Bump database_cleaner from 1.6.2 to 1.7.0 [\#3014](https://github.com/consuldemocracy/consuldemocracy/pull/3014)
...
- **Maintenance-Gems:** Bump knapsack_pro from 0.53.0 to 1.1.0 [\#2999](https://github.com/consuldemocracy/consuldemocracy/pull/2999)
- **Maintenance-Gems:** Bump letter_opener_web from 1.3.2 to 1.3.4 [\#2957](https://github.com/consuldemocracy/consuldemocracy/pull/2957)
...
- **Proposals:** Optimize task reset_hot_score [\#3116](https://github.com/consuldemocracy/consuldemocracy/pull/3116)
...
- **Maintenance-Specs:** Fix failing spec: Budget::Investment Reclassification store_reclassified_votes stores the votes for a reclassified investment [\#3067](https://github.com/consuldemocracy/consuldemocracy/pull/3067)
- **Maintenance-Specs:** Fix failing spec: Poll::Shift officer_assignments creates and destroy corresponding officer_assignments [\#3061](https://github.com/consuldemocracy/consuldemocracy/pull/3061)
- **Maintenance-Specs:** Update debates_spec.rb [\#3029](https://github.com/consuldemocracy/consuldemocracy/pull/3029)
...
- **Maintenance-Gems:** Bump delayed_job_active_record from 4.1.2 to 4.1.3 [\#2927](https://github.com/consuldemocracy/consuldemocracy/pull/2927)
...
- **Maintenance-Gems:** Bump scss_lint from 0.54.0 to 0.55.0 [\#2895](https://github.com/consuldemocracy/consuldemocracy/pull/2895)
...
- **Maintenance-Refactorings:** Change spelling for constant to TITLE_LENGTH_RANGE [\#2966](https://github.com/consuldemocracy/consuldemocracy/pull/2966)
...
- **Maintenance:** add proposal image on dev_seeds task [\#2768](https://github.com/consuldemocracy/consuldemocracy/pull/2768)
...
- **Maintenance:** Avoid db:dev_seed log print when run from its test [\#2598](https://github.com/consuldemocracy/consuldemocracy/pull/2598)
...
- **Maps:** Fix MapLocation json_data to return mappable ids [\#2613](https://github.com/consuldemocracy/consuldemocracy/pull/2613)
...
- **Maintenance:** Make config.time_zone configurable at secrets.yml [\#2468](https://github.com/consuldemocracy/consuldemocracy/pull/2468)
